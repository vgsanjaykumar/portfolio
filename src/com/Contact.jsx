          ...
          <div className=' w-full'>
            <form className='space-y-4' onSubmit={onSubmit}>
              <div>
                ...
                <input type="text" className='footer-input' name='name'
              ...
              <div>
                ...
                <input type="text" className='footer-input' name='number'
                  placeholder='Enter your Number' />
              </div>

              <div>
                <label htmlFor="email" className='formlabile'>Message</label>
                <textarea type="text" className='footer-input' name='message'
                  rows="5"
